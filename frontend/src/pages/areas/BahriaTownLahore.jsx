...
const areaSchema = {
  ...
  "@type": "Service",
  "name": "Home Physiotherapy in Bahria Town Lahore",
  ...
  "description": "Doctor of Physical Therapy (DPT) home visit services across Bahria Town Lahore (Sectors A-F) for back pain, stroke rehab & elderly mobility."
};

const faqs = [
  {
    q: "Do you provide home physical therapy in Bahria Town Lahore?",
    a: "Yes. Our Doctors of Physical Therapy deliver home visit sessions across Bahria Town Sectors A, B, C, D, E, F, Executive Enclave, and Safari Villas."
  }
];
    ...
    <div className="w-full pt-32 pb-24 bg-[#FDFBF9]">
      <SEO 
        ...
        breadcrumbs={[
          ...
          { name: "Bahria Town", path: "/areas-we-cover/bahria-town-lahore" }
        ]}
      />
      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-xs font-bold uppercase tracking-wider mb-6">
            ...
            <span>Dedicated Service Zone • Bahria Town Lahore</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-foreground mb-6 leading-tight">
            Home Physiotherapy in Bahria Town Lahore
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            In-home Doctor of Physical Therapy visits delivered to your residence in Bahria Town.
          </p>
        </div>

        <div className="organic-card p-8 md:p-12 mb-16 bg-white border border-border/40 shadow-sm">
          <h2 className="text-2xl font-serif font-bold mb-4 text-foreground">Bahria Town Sectors Covered</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-4 border-t border-border/30">
            {[
              "Sector A & Sector B",
              "Sector C & Sector D",
              "Sector E & Sector F",
              "Safari Villas & Executive Enclave",
              "Jasmine Block & Tulip Block",
              "Ghani Development & Canal Fort"
            ].map((area, idx) => (
        ...
        <div className="bg-[#2C3E2D] text-white p-10 md:p-14 rounded-[3rem] text-center space-y-6 shadow-xl">
          <h2 className="text-3xl md:text-4xl font-serif font-bold">Book a Home Physiotherapist in Bahria Town</h2>
          <div className="flex flex-wrap justify-center gap-4 pt-2">
            <Link to="/booking" state={{ selectedArea: "Bahria Town" }} className="px-8 py-4 bg-white text-[#2C3E2D] font-bold rounded-2xl hover:bg-gray-100 transition-all">
              Book Visit in Bahria Town
            </Link>
